...
Zip code are identifiers for geographical areas and are not values with any inherent numerical meaning. 
...
**Modelling zip code categorically:**
  ...
  - As an example, the model can learn that average real estate prices inzip code "50025" are highest $328219.135135, while those in zip code "50014" are $220993.000000 are less expensive, but difference is price is due to location and not because of numerical difference between the two zip codes.

**Modelling zip code numerically:**

  - Treating zip code as a numerical data implies that the numrical difference between the two zip codes as a meaning (i.e. zip code 50025 is "numerically greater than" zip code 50014 and thus potentially expensive than zip code 50014 in linear way). 
